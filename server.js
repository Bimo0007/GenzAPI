...
import { registerJournalSeedRoute } from './journalSeed.js';
...
// TEMPORARY — one-time journal backfill, see journalSeed.js. Remove this
// line and the file once it's been run.
registerJournalSeedRoute(app);
